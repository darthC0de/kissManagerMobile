...
export default function ManagerPassword(props: any) {
  ...
  const [updatePasswords, setUpdatePasswords] = useState<boolean>(
    props.route.params ? props.route.params.updatePasswords : false,
  );
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.containerPassword}>
        {passwords.map(password => (
          <TouchableOpacity
            key={password.id}
            onPress={() => handleViewPassword(password.id)}
